        ...
        for ep in range(episodes):
            ...
            while not terminal:
                ...
                for i in range(self.share_iter):
                    for agent_i in range(self.model.n_agents):
                        thoughts[agent_i] = (thoughts[agent_i] + thoughts[(agent_i + 1) % len(thoughts)]) / 2
