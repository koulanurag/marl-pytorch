...
class EnvMoveBox(object):
    def __init__(self):
        ...
        self.action_space = [spaces.Discrete(4) for _ in range(2)]
    ...
    def step(self, action_list):
        ...
        if self.is_1_catch_box and self.is_2_catch_box:
            if action_list[0] == 0 and action_list[1] == 0:  # up
                if self.occupancy[self.box_pos[0] - 1, self.box_pos[1]] == 0 and self.occupancy[
                    self.box_pos[0] - 1, self.box_pos[1] - 1] == 0 and self.occupancy[
                    self.box_pos[0] - 1, self.box_pos[1] + 1] == 0:
        ...
        obs = self.get_obs()
        return obs, reward_list, [done for _ in range(2)], {}
    ...
    def get_agt1_obs(self):
        ...
        obs[self.box_pos[0], self.box_pos[1], 2] = 0
        # return obs
        return [self.agt1_pos[0], self.agt1_pos[1], self.box_pos[0], self.box_pos[1]]
    ...
    def get_agt2_obs(self):
        ...
        obs[self.box_pos[0], self.box_pos[1], 2] = 0
        # return obs
        return [self.agt2_pos[0], self.agt2_pos[1], self.box_pos[0], self.box_pos[1]]
    ...
    def render(self):
        ...
        cv2.rectangle(obs, (self.agt1_pos[1] * 20, self.agt1_pos[0] * 20),
                      (self.agt1_pos[1] * 20 + 20, self.agt1_pos[0] * 20 + 20), (0, 0, 255), -1)
        cv2.rectangle(obs, (self.agt2_pos[1] * 20, self.agt2_pos[0] * 20),
                      (self.agt2_pos[1] * 20 + 20, self.agt2_pos[0] * 20 + 20), (255, 0, 0), -1)
