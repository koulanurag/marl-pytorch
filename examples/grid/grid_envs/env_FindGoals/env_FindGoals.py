...
class EnvFindGoals(object):
    ...
    def step(self, action_list):
        ...
        return self.get_obs(), [reward_1, reward_2], [done for _ in range(2)], {}
    ...
    def render(self):
        ...
        cv2.rectangle(obs, (self.agt2_pos[0] * 20, (3 - self.agt2_pos[1]) * 20),
                      (self.agt2_pos[0] * 20 + 20, (3 - self.agt2_pos[1]) * 20 + 20), (255, 0, 0), -1)
        cv2.rectangle(obs, (self.agt1_pos[0] * 20, (3 - self.agt1_pos[1]) * 20),
                      (self.agt1_pos[0] * 20 + 20, (3 - self.agt1_pos[1]) * 20 + 20), (0, 0, 255), -1)
